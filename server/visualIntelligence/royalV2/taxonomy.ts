...
const PERSON_ALIASES: Record<string, string[]> = {
  ...
  "Frances Shand Kydd": ["frances shand kydd", "shand kydd", "frances ruth roche", "diana's mother"],
  "Lady Sarah McCorquodale": ["lady sarah mccorquodale", "sarah mccorquodale", "diana's sister sarah"],
  "Lady Jane Fellowes": ["lady jane fellowes", "jane fellowes", "diana's sister jane"],
  "Charles Spencer": ["charles spencer", "earl spencer", "9th earl spencer", "diana's brother"],
